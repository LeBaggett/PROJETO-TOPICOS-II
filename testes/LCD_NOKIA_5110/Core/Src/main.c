...
int main(void)
{
  ...
  gLcdScreen.mPinout.mLcdSpiRstPort = LCD_RESET_GPIO_Port;
  gLcdScreen.mPinout.mLcdSpiRstPin = LCD_RESET_Pin;
  ...
  gLcdScreen.mPinout.mLcdErrorLedPort = GPIOC;
  gLcdScreen.mPinout.mLcdErrorLedPin = GPIO_PIN_13;
