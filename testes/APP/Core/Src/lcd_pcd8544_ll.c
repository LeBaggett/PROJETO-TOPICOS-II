...
// =============================================================================
// GPIO CONTROL (MISSING IMPLEMENTATION)
// =============================================================================

void LCD_PCD8544_LL_reset(LCD_PCD8544_screen_t* scr)
{
    HAL_GPIO_WritePin(scr->mPinout.mLcdSpiRstPort,
                      scr->mPinout.mLcdSpiRstPin,
                      GPIO_PIN_RESET);
    HAL_Delay(10);
    HAL_GPIO_WritePin(scr->mPinout.mLcdSpiRstPort,
                      scr->mPinout.mLcdSpiRstPin,
...
{
    HAL_GPIO_WritePin(scr->mPinout.mLcdSpiDcPort,
                      scr->mPinout.mLcdSpiDcPin,
                      GPIO_PIN_RESET);
}
...
{
    HAL_GPIO_WritePin(scr->mPinout.mLcdSpiCePort,
                      scr->mPinout.mLcdSpiCePin,
                      GPIO_PIN_RESET);
}
